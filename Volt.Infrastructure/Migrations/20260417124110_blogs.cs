        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostLink = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NewsPostLanguages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NewsPostLanguages_NewsPosts_NewsPostId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NewsPostLanguages_NewsPostId_LanguageCode",
                table: "NewsPostLanguages",
                columns: new[] { "NewsPostId", "LanguageCode" },
                unique: true);
        }
