...
echo "Before onboarding, confirm that the WhatsApp Business Account webhook subscribes to:"
echo "  messages"
echo "  history"
echo "  smb_message_echoes"
echo "  smb_app_state_sync"
echo "Use scripts/diagnose-whatsapp-inbox-prod-ftp.sh to verify the production field subscriptions."
