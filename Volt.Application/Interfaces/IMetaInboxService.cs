...
namespace Volt.Application.Interfaces
{
    public interface IMetaInboxService
    {
        ...
        Task<ApiResponse<IReadOnlyList<MetaInboxMessageDto>>> GetMessagesAsync(int conversationId, long? afterId, CancellationToken ct = default);
        Task<ApiResponse<IReadOnlyList<MetaInboxInternalNoteDto>>> GetNotesAsync(int conversationId, long? afterId, CancellationToken ct = default);
        Task<ApiResponse<IReadOnlyList<MetaInboxAssigneeDto>>> GetAssigneesAsync(CancellationToken ct = default);
        ...
        Task<ApiResponse<MetaInboxConversationDto>> MarkReadAsync(int conversationId, CancellationToken ct = default);
